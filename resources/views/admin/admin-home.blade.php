                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <button onclick="openAddBookModal()"
                            class="flex items-center p-4 border border-gray-300 hover:border-gray-400 rounded-lg transition-colors text-left">
                        ...
                        <a href="{{ route('admin.manage_books') }}"
                            class="flex items-center p-4 border border-gray-300 hover:border-gray-400 rounded-lg transition-colors">
                        ...
                        <a href="{{ route('admin.customer_orders') }}"
                            class="flex items-center p-4 border border-gray-300 hover:border-gray-400 rounded-lg transition-colors">
                        ...
                        <a href="{{ route('admin.backups.index') }}"
                            class="flex items-center p-4 border border-gray-300 hover:border-gray-400 rounded-lg transition-colors">
                            <span class="text-gray-700 font-medium"> Backups</span>
                        </a>

                        <a href="{{ route('audit.index') }}"
                            class="flex items-center p-4 border border-gray-300 hover:border-gray-400 rounded-lg transition-colors">
                            <span class="text-gray-700 font-medium"> Audit Logs</span>
                        </a>
                    </div>
                </div>
            </div>
