...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        ...
        $middleware->alias([
            ...
            'ApiRateLimiter' => \App\Http\Middleware\ApiRateLimiter::class,
            'ApiTransformResponse' => \App\Http\Middleware\ApiTransformResponse::class,
            'ETagCaching' => \App\Http\Middleware\ETagCaching::class,
        ]);
    })
